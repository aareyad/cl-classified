...
$primary_light   = Options::$options['primary_lighiten']; //#50ffe4
$primary_light2  = Options::$options['primary_lighiten2']; //#50ffe4
$primary_light3  = Options::$options['primary_lighiten3']; //#50ffe4
$primary_dark    = Options::$options['primary_dark']; //#50ffe4
...
$menu_color                   = Options::$options['menu_color'];
$transparent_menu_color       = Options::$options['transparent_menu_color'];
$transparent_menu_color_hover = Options::$options['transparent_menu_color_hover'];
$menu_background              = Options::$options['menu_background'];
$sticky_menu_background       = Options::$options['sticky_menu_background'];
$sub_menu_color               = Options::$options['sub_menu_color'];
$menu_hover_color             = Options::$options['menu_hover_color'];
$menu_arrow_color             = Options::$options['menu_arrow_color'];
$btn_color                    = Options::$options['btn_color'];
$btn_hover_color              = Options::$options['btn_hover_color'];
$menu_icon_color              = Options::$options['menu_icon_color'];
$menu_icon_hover_color        = Options::$options['menu_icon_hover_color'];
$header_transparent_color     = Options::$options['header_transparent_color'];
$breadcrumb_bg1               = Options::$options['breadcrumb_bg1'];
$breadcrumb_bg2               = Options::$options['breadcrumb_bg2'];
$breadcrumb_color             = Options::$options['breadcrumb_color'];
$breadcrumb_active_color      = Options::$options['breadcrumb_active_color'];
$footer_bg                    = Options::$options['footer_bg'];
$footer2_bg_overlay           = Options::$options['footer2_bg_overlay'];
$footer2_bg_overlay_opacity   = Options::$options['footer2_bg_overlay_opacity'];
$footer2_copyright_bg         = Options::$options['footer2_copyright_bg'];
$footer2_copyright_text_color = Options::$options['footer2_copyright_text_color'];
$footer_title_border_color    = Options::$options['footer_title_border_color'];
$footer_text                  = Options::$options['footer_text_color'];
$footer2_text                 = Options::$options['footer2_text_color'];
$footer_text_hover            = Options::$options['footer_text_hover'];
$footer2_text_hover           = Options::$options['footer2_text_hover'];
$copyright_bg                 = Options::$options['copyright_bg'];
$copyright_text               = Options::$options['copyright_text_color'];
$footer_title                 = Options::$options['footer_title_color'];
$footer2_title                = Options::$options['footer2_title_color'];

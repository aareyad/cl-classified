...
use RadiusTheme\Classified\Options;
...
<div id="primary" class="content-area erorr-page">
	...
	<img width="412" height="412" src="<?php echo Helper::get_img('404-layer.png') ?>" alt="<?php esc_attr_e('Animated Image', 'homlisti') ?>" data-position="<?php echo esc_attr('-100') ?>" class="follow-with-mouse animate-image img3">
		...
		<div class="erorr-box">
			...
			<h2 class="item-title">
				<?php
					echo wp_kses( Options::$options['error_text'], array(
						'a' => array(
							'href' => array(),
							'title' => array()
						),
			...
			<div class="item-subtitle">
				<?php
					echo wp_kses( Options::$options['error_subtitle'], array(
						'br' => array(),
					) );
				?>
			</div>
			<a class="item-btn rt-animation-btn" href="<?php echo esc_url( home_url( '/' ) );?>"><?php echo esc_html( Options::$options['error_buttontext'] ); ?></a>
		</div>
	</div>
</div>
<?php get_footer();
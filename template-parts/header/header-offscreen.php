...
$loc_text = esc_attr__( 'Select Location', 'cl-classified' );
$style    = isset( Options::$options['listing_search_style'] ) ? Options::$options['listing_search_style'] : 'popup';
    ...
    <div class="rt-header-menu mean-container" id="meanmenu">
        <div class="mean-bar">
			...
			/*if ( Options::$options['header_btn_txt'] && Options::$options['header_btn_url'] ) {
				$html .= '<a class="header-btn header-menu-btn header-menu-btn-mob" href="' . esc_url( Options::$options['header_btn_url'] ) . '"><i class="fas fa-plus" aria-hidden="true"></i><span>' . esc_html( Options::$options['header_btn_txt_mob'] ) . '</span></a>';
			}*/
			...
			/*if ( class_exists( 'RtclPro' ) && class_exists( 'Rtcl' ) && Options::$options['header_icon'] ) {
...
<?php if ( ! empty( Options::$options['listing_search_items']['keyword'] ) || ! empty( Options::$options['listing_search_items']['location'] ) ): ?>
    <div class="main-header-inner mobile-header-search">
        <div class="main-navigation-area">
            <form action="<?php echo esc_url( Functions::get_filter_form_url() ); ?>"
				...
				<?php if ( ! empty( Options::$options['listing_search_items']['location'] ) ): ?>
					...
					<?php else: ?>
						...
						<?php if ( ! empty( Options::$options['listing_search_items']['radius'] ) ): ?>
				...
				<?php if ( ! empty( Options::$options['listing_search_items']['keyword'] ) ): ?>

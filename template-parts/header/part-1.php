...
$light_logo = empty( Options::$options['logo_light']['url'] ) ? Helper::get_img( 'logo-light.png' ) : Options::$options['logo_light'];
$dark_logo = empty( Options::$options['logo']['url'] ) ? Helper::get_img( 'logo-dark.png' ) : Options::$options['logo'];

$logo_width = (int) Options::$options['logo_width'];
		...
		<div class="main-navigation-area">
			<?php if ( Options::$options['header_btn_txt'] && Options::$options['header_btn_url'] ): ?>
				<div class="header-btn-area">
					<a class="header-btn" href="<?php echo esc_url( Options::$options['header_btn_url'] );?>"><i class="fas fa-plus" aria-hidden="true"></i><?php echo esc_html( Options::$options['header_btn_txt'] );?></a>
				</div>
			<?php endif; ?>
			...
			<?php if ( Helper::is_chat_enabled() ): ?>
				<a class="header-chat-icon rtcl-chat-unread-count" title="<?php esc_html_e( 'Chat','cl-classified' );?>" href="<?php echo esc_url( Link::get_my_account_page_link( 'chat' ) ); ?>"><i class="far fa-comments" aria-hidden="true"></i></a>
			<?php endif; ?>
